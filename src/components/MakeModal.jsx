...
import { MakeBuy } from "./MakeBuy";

//{routedishes}はprops  で関数の引数に,routedishesはオブジェトで渡さないといけないから渡せない.
//バケツリレーで引き渡すやつを変えて,関数コンポーネントを複製する　いつか関数の切り出しを行ってうまくできるようになりたい.
//状況　今関数BasicUsage2({}) とExtraComponents　を使ってTakeOutを作っていた(引数がわからなくなるので,以下にコピーを示す)

//つまり　全く同じ働きをするBasicUsage3 と　ExtraComponents3
...
export function ExtractionComponents({ s, c, setRouteDish }) {
  ...
  //commentsには,ばらばらに<div>で囲われた物が入ってる
